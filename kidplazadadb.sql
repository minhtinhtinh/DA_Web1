/*
 ...
 Source Schema         : kidplazadadb

 Target Server Type    : MySQL
 Target Server Version : 50714
 File Encoding         : 65001

 Date: 11/12/2018 10:21:19
*/
...
-- Records of order
-- ----------------------------
INSERT INTO `order` VALUES (1, 'abc', '2018-11-29', 'chờ duyệt', 'Nguyễn Văn Cừ, Quận 5, TP HCM', 2, 1000);
INSERT INTO `order` VALUES (2, 'abc', '2018-11-29', 'đang giao', 'Nguyễn Văn Cừ, Quận 5, TP HCM', 2, 500);
INSERT INTO `order` VALUES (3, 'abc', '2018-11-29', 'chờ duyệt', 'Nguyễn Văn Cừ, Quận 5, TP HCM', 2, 1500);
...
CREATE TABLE `orderdetail`  (
  ...
  PRIMARY KEY (`product`, `count`, `orderID`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of orderdetail
-- ----------------------------
INSERT INTO `orderdetail` VALUES ('BB0001', 2, 3);
INSERT INTO `orderdetail` VALUES ('RB0001', 5, 3);
INSERT INTO `orderdetail` VALUES ('X00001', 1, 1);
INSERT INTO `orderdetail` VALUES ('X00001', 1, 2);
INSERT INTO `orderdetail` VALUES ('X00002', 1, 2);
INSERT INTO `orderdetail` VALUES ('X00002', 2, 1);
...
INSERT INTO `user` VALUES ('admin', '202cb962ac59075b964b07152d234b70', 1, NULL, '', NULL);
