      ...
      <div class="using-border py-3">
         <div class="inner_breadcrumb  ml-4">
            <ul class="short_ls">
               ...
               <li>
                  <?php
                        $table_category1=mysqli_query($connect,"select * from category");  
                        while ($row_category1=mysqli_fetch_array($table_category1))
                        {
                           if($row_category1['id']==$id_request)
                           {
                              echo $row_category1['name'];
                           }
                        }            
                     ?>
               </li>
            ...
            <div class="left-ads-display col-lg-9">
               <div class="row">
                  ...
                  //bắt đầu phân trang
                     ...
                     $c_sql = mysqli_query($connect,"select count(*) as num_rows from product where category = ".$id_request);//đếm số lượng số sản phẩm trong database
                    ...
                    $table=mysqli_query($connect,"select * from product where category = '".$id_request."' limit $offset, $limit ");                     
